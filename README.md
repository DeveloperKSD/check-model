# Define the markdown content exactly as requested by the user, ensuring correct formatting for code blocks.
readme_content = """# Multi-LLM API Model Discovery Scripts
